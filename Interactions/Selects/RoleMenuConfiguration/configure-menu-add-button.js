...
module.exports = {
    ...
    Name: "configure-menu-add-button",

    // Select's Description
    Description: `Handles setting the Button colour for Role Buttons on Menus during configuration`,
    ...
    async execute(interaction)
    {
        ...
        const MenuButtonModal = new ModalBuilder().setCustomId(`configure-menu-button-text_${RoleID}_${ButtonType}`).setTitle(localize(interaction.locale, 'ROLE_MENU_SET_BUTTON_LABEL')).addComponents([
