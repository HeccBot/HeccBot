...
module.exports = {
    ...
    Name: "create-menu-add-role",

    // Select's Description
    Description: `Handles Role Select for adding a Role to a Menu during creation`,
    ...
    async execute(interaction)
    {
        ...
        const ButtonTypeSelect = new ActionRowBuilder().addComponents([
            new StringSelectMenuBuilder().setCustomId(`create-menu-add-button_${InputRole.id}`).setMinValues(1).setMaxValues(1).setPlaceholder(localize(interaction.locale, 'ROLE_MENU_SELECT_BUTTON_COLOR')).setOptions([
