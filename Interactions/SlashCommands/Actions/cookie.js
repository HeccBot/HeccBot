...
module.exports = {
    ...
    LocalisedDescriptions: {
        'en-GB': `Give a User a cookie!`,
        'en-US': `Give a User a cookie!`
    },
        ...
        Data.options = [
            {
                ...
                name: "person",
                description: "Person you want to give a cookie to",
                description_localizations: {
                    'en-GB': `Person you want to give a cookie to`,
                    'en-US': `Person you want to give a cookie to`
                },
                required: true
            },
            {
