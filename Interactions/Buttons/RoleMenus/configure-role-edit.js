...
module.exports = {
    ...
    async execute(interaction)
    {
        ...
        const EditButtonModal = new ModalBuilder().setCustomId(`configure-menu-edit-button_${RoleID}`).setTitle(`${localize(interaction.locale, 'ROLE_MENU_EDIT_BUTTON_LABEL')}`).addComponents([
