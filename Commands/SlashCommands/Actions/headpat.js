...
export const SlashCommand = {
     ...
     * @type {String}
     */
    description: "Comfort the selected target with a gentle headpat",

    /** Command's Localised Descriptions
     * @type {import('discord-api-types/v10').LocalizationMap}
     */
    localizedDescriptions: {
        'en-GB': 'Comfort the selected target with a gentle headpat',
        'en-US': 'Comfort the selected target with a gentle headpat'
    },
        ...
        CommandData.options = [
            {
                ...
                name: "target",
                description: "The target you want to give a headpat to",
                description_localizations: {
                    'en-GB': "The target you want to give a headpat to",
                    'en-US': "The target you want to give a headpat to"
                },
                required: true
            },
            {
