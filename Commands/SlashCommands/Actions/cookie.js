...
export const SlashCommand = {
     ...
     * @type {String}
     */
    description: "Gives the selected target a cookie!",

    /** Command's Localised Descriptions
     * @type {import('discord-api-types/v10').LocalizationMap}
     */
    localizedDescriptions: {
        'en-GB': 'Gives the selected target a cookie!',
        'en-US': 'Gives the selected target a cookie!'
    },
        ...
        CommandData.options = [
            {
                ...
                name: "target",
                description: "The target you want to give a cookie to",
                description_localizations: {
                    'en-GB': "The target you want to give a cookie to",
                    'en-US': "The target you want to give a cookie to"
                },
                required: true
            },
            {
