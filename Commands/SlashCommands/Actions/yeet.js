...
export const SlashCommand = {
     ...
     * @type {String}
     */
    description: "Throw the selected target!",

    /** Command's Localised Descriptions
     * @type {import('discord-api-types/v10').LocalizationMap}
     */
    localizedDescriptions: {
        'en-GB': 'Throw the selected target!',
        'en-US': 'Throw the selected target!'
    },
        ...
        CommandData.options = [
            {
                ...
                name: "target",
                description: "The target you want to throw",
                description_localizations: {
                    'en-GB': "The target you want to throw",
                    'en-US': "The target you want to throw"
                },
                required: true
            },
            {
