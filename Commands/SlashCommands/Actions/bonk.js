...
export const SlashCommand = {
     ...
     * @type {String}
     */
    description: "Bonk the selected target for being naughty!",

    /** Command's Localised Descriptions
     * @type {import('discord-api-types/v10').LocalizationMap}
     */
    localizedDescriptions: {
        'en-GB': 'Bonk the selected target for being naughty!',
        'en-US': 'Bonk the selected target for being naughty!'
    },
        ...
        CommandData.options = [
            {
                ...
                description_localizations: {
                    'en-GB': "The target you want to bonk",
                    'en-US': "The target you want to bonk"
                },
                required: true
            },
            {
