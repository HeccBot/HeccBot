...
export const SlashCommand = {
     ...
     * @type {String}
     */
    description: "Kiss the selected target!",

    /** Command's Localised Descriptions
     * @type {import('discord-api-types/v10').LocalizationMap}
     */
    localizedDescriptions: {
        'en-GB': 'Kiss the selected target!',
        'en-US': 'Kiss the selected target!'
    },
        ...
        CommandData.options = [
            {
                ...
                name: "target",
                description: "The target you want to kiss",
                description_localizations: {
                    'en-GB': "The target you want to kiss",
                    'en-US': "The target you want to kiss"
                },
                required: true
            },
            {
            ...
            },
            {
                type: ApplicationCommandOptionType.Boolean,
                name: "allow-return",
                description: "Should the \"Return Kiss\" button be included? (default: true)",
                description_localizations: {
                    'en-GB': "Should the \"Return Kiss\" button be included? (default: true)",
                    'en-US': "Should the \"Return Kiss\" button be included? (default: true)"
                },
                required: false
            },
            {
